...
//        bubbleSort(numbers);
    ...
    1st FOR i = 0
    2nd FOR j = 0, pana la n-1-i( punem acel -i, pt a restrange cu 1 la fiecare iteratie sublista nesortata in stanga)
...
---------------------------
   i=3 , j = 0 -> 1,4 , lisa finala va fi 1 4 5 8 92
---------------------------
done

        Parcurgem lista si facem comparatii adiacente de valori.
        Pt ordine ascendenta -> elementul din stanga < elementul din dreapta
        Daca elementele nu sunt in ordinea corecta, le inversam
         */
