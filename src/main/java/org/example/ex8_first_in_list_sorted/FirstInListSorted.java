...
/*
Same exercise as 7, only with Comparable interface Loombok .
 */
public class FirstInListSorted {
    ...
    public static void main(String[] args) {
        ...
        employees.forEach(System.out::println); // it-> sout(it) , acelasi lucru cu enhanced for
    ...
    public static EmployeeSorted getFirstEmployeeWithSalaryOverStream(List<EmployeeSorted> employees, int threshold) {
        //peek = e o metoda de stream care iti permite sa te uiti in substratul creat
